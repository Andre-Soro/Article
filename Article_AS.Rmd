...
### L'importance de la prise en compte du climat et de l'héritabilité des caractères dans les les programmes de selection génétique
<!-- Ca part en couille il n'y a plus de logique. Quel message veux tu faire passer ? Tu te tires une balle dans le pied en disant l'inverse de que tu as dit avant ! --> 
The time-frame of improved forest management being long [@Zobel1972] it is important to anticipate future changes in environmental conditions in these programs [@Gray2016]. This will allow the establishment of plantations capable of adapting to the water stress and possible significant rainfall related to climate change because climate predictions predict more variations in the coming years [@IPCC2007; @pachauri2014]. In fact, with the increasing temperature, the trees are expected to growth faster and thus being of lower quality because of lower density [@corriveau1987; @DeBell1994; @Lindstrom1996; @Dutilleul1998; @Bouriaud2005] hence, the importance of integrating these factors into genetic selection programs. However, to select trees that are prone to produce wood of homogeneous density we must also ensure that these properties will persist in time with climatic change. Thus the selection must also considered the stability of the properties in time or, more accurately, with climate change. Furthermore, heritability of density has been proven in several studies, but there is no evidence to suggest that density variability is hereditary. The heritability of this trait could qualify it for the selection criteria for future breeding programs for producing better quality wood.\ 

### Le but de notre étude et ce que nous avons fait. 
In this study we quantified and compared heterogeneity of wood density from trees of known parents in order to figure out if some individuals produce more heterogeneous wood than others. Knowing the parents of each tree we tried to characterize the genetic contribution to the heterogeneity by comparing two growth sites we tried to characterize the environmental contribution to homogeneity. We ultimately aim to select and reproduce trees families of interest that are both low-sensitivity to climate change and genetically prone to make homogeneous wood. Thus, the most homogeneous families will be identified for reforestation and identify variables to consider in breeding of growing trees with less variable wood.
...
![Study sites](graph_table/Study.sites.png){width=400px; height=400px}
